...
public class hangman {
    ...
    public static void start(IChannel channel) {
        try {
            ...
            Bot.logger.log(Level.WARNING, "error: " + exc);
        }
    }
    ...
    public static void endGame(IUser user, boolean win) {
        ...
        try {
            ...
            Bot.logger.log(Level.WARNING, "error sending message");
        }
    ...
    private static String getRandWord() {
        try {
            ...
            Bot.logger.log(Level.WARNING, "problem with hangman resource file: " + exc);
            return ("Error?");
        }
    }
